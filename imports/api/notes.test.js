...
if (Meteor.isServer) {
  describe('notes', function() {
    ...
    it('should not remove if note id not provided', function() {
      expect(() => {
    ...
    it('should not update if note id not provided', function() {
      expect(() => {
    ...
    it('should return zero notes for user that has none', function() {
      const res = Meteor.server.publish_handlers.notes.apply({ userId: 'garbageId' });
      const notes = res.fetch();
